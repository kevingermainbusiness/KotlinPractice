 ...
 * to get the lock, associated with the specified object.
 ...
 */
public class DeadlockTweenTwoThreads {
    final String str1 = "Java";
    final String str2 = "UNIX";
    ...
    public static void main(String[] args) {
        DeadlockTweenTwoThreads deadlockTweenTwoThreads = new DeadlockTweenTwoThreads();
        deadlockTweenTwoThreads.trd1.start();
        deadlockTweenTwoThreads.trd2.start();
    }
}
